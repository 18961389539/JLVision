...
public class JlXLDExtPara : JlXLD, ISerializable, ICloneable
{
	...
	/// <summary>把已有原生扩展平行线对句柄包成托管 JlXLDExtPara：执行引用计数拷贝（CopyObject），不是元素数据深拷贝；随后断言原生对象类为 xld_ext_para。</summary>
	...
	/// <summary>按原生句柄构造扩展平行线对容器，copy 决定是"CopyObject 加引用"还是"直接接管裸句柄"；随后断言对象类为 xld_ext_para。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	...
	/// <summary>把任意 JlObject 包装/复制成扩展平行线对容器：对其句柄做引用计数拷贝并做原生类名校验，非 xld_ext_para 类型抛 JlException。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	...
	/// <summary>把原生过程某槽位的输出句柄装载进全新 JlXLDExtPara（"返回新句柄"路径的统一出口），透传错误码、自身不抛异常。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	...
	/// <summary>ISerializable 反序列化构造器：从 info 的 "data" 键取出字节块，经 DeserializeXld（原生 id 1552）原地重建扩展平行线对容器。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
