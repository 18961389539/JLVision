...
/// <summary>表示一个 XLD 多边形对象（或对象数组）的实例。</summary>
[Serializable]
public class JlXLDPoly : JlXLD, ISerializable, ICloneable
{
	...
	/// <param name="sub">包围被减去区域（从第一个区域中减去）的多边形。</param>
	...
	/// <param name="polygons2">包围待求交的第二个区域的多边形。</param>
	...
	/// <param name="numObj">待复制对象的数量或 -1。Default: 1</param>
	...
	/// </summary>
	/// <param name="index">待选择对象的索引。Default: 1</param>
	...
	/// <param name="gridSpacing">校正后图像中网格点的间距。</param>
	...
	/// <param name="genParamName">可为 DXF 输入调整的通用参数名称。Default: []</param>
	...
	/// <param name="min">各特征的下限或 'min'。Default: 150.0</param>
	...
	/// </summary>
	/// <param name="index">待移除对象的索引。</param>
