...
public class JlMatrix : JlHandle, ISerializable, ICloneable
{
	...
	/// <summary>包装已有的原生 JlHandle，并校验其语义类型为矩阵。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	...
	/// </summary>
	/// <param name="rows">矩阵行数。默认值 3</param>
	/// <param name="columns">矩阵列数。默认值 3</param>
	...
	/// <param name="rows">矩阵行数。默认值 3</param>
	/// <param name="columns">矩阵列数。默认值 3</param>
	/// <param name="value">填充到每个元素的常数。默认值 0</param>
	/// <remarks>
	...
	/// <summary>从序列化数据重建矩阵实例（ISerializable 反序列化构造）。</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	...
	///   把本矩阵写入文件。
	/// </summary>
	/// <param name="fileFormat">文件格式。默认值 "binary"</param>
	...
	/// </summary>
	/// <param name="decompositionType">分解方法。默认值 "qr"</param>
	/// <param name="outputMatricesType">输出矩阵形态。默认值 "full"</param>
	/// <param name="computeOrthogonal">是否计算正交矩阵。默认值 "true"</param>
	...
	/// </summary>
	/// <param name="matrixType">输入矩阵类型。默认值 "general"</param>
	...
	/// </summary>
	/// <param name="SVDType">计算类型。默认值 "full"</param>
	/// <param name="computeSingularVectors">奇异向量计算范围。默认值 "both"</param>
	...
	/// <param name="computeEigenvectors">是否计算特征向量。默认值 "none"</param>
	...
	/// <param name="computeEigenvectors">是否计算特征向量。默认值 "false"</param>
	...
	/// </summary>
	/// <param name="matrixLHSType">左端（系数）矩阵类型。默认值 "general"</param>
	/// <param name="epsilon">求解方式及把奇异值视为 0 的阈值。默认值 0.0</param>
	...
	/// </summary>
	/// <param name="maxType">求最大的归约方向。默认值 "columns"</param>
	...
	/// </summary>
	/// <param name="minType">求最小的归约方向。默认值 "columns"</param>
	...
	/// <param name="meanType">均值计算的归约方向。默认值 "columns"</param>
	...
	/// <param name="sumType">求和的归约方向。默认值 "columns"</param>
	...
	/// <param name="factor">缩放系数（标量）。默认值 2.0</param>
	/// <remarks>
	...
	/// <param name="rows">输入矩阵在行方向平铺的份数。默认值 2</param>
	/// <param name="columns">输入矩阵在列方向平铺的份数。默认值 2</param>
	...
	/// <param name="vectorID">含待设置对角元素的矩阵句柄。</param>
	...
	/// <param name="diagonal">所需对角线的编号。默认值 0</param>
	...
	/// <param name="matrixSubID">输入子矩阵的句柄。</param>
	/// <param name="row">子矩阵左上角落在 this 中的起始行号（INTEGER）。</param>
	...
	/// <param name="row">子矩阵在输入矩阵中的上边界行位置。默认值 0</param>
	/// <param name="column">子矩阵在输入矩阵中的左边界列位置。默认值 0</param>
	/// <param name="rowsSub">子矩阵的行数。默认值 1</param>
	/// <param name="columnsSub">子矩阵的列数。默认值 1</param>
	...
	/// <summary>用一条元组整表覆写矩阵元素：原地写入全部值，不改变行列数。</summary>
	...
	///   <code>
	///   JlMatrix m = new JlMatrix(2, 2, 0.0);
	///   m.SetFullMatrix(new double[] { 1.0, 2.0, 3.0, 4.0 });
	///   double v = m[0, 1];
	///   m.Dispose();
	///   </code>
	///   <para><b>资源与坑</b>double[]/int[] 靠 JlTuple 的隐式转换进元组形参，只匹配本重载、不会与 (double) 撞车；要传标量请走 SetFullMatrix(double)。传入的 JlTuple 由方法内部解除固定，但对象本身仍归你，需要时自行 Dispose。</para>
	/// </remarks>
	...
	/// <summary>用同一个标量铺满整个矩阵：原地把全部元素覆写成该值，不改维度。</summary>
	/// <param name="values">待设置的值。</param>
	/// <remarks>
	...
	///   m.Dispose();
	///   </code>
	///   <para><b>资源与坑</b>示例用 double 字面量 0.0 而非整数 0：整数字面量会同时命中 (double) 的数值提升与 (JlTuple) 的双向隐式转换，可能触发 CS0121 重载二义；标量一律写带小数点的字面量。</para>
	/// </remarks>
	...
	/// <param name="row">待修改矩阵元素的行号。默认值 0</param>
	/// <param name="column">待修改矩阵元素的列号。默认值 0</param>
	...
	/// <param name="row">待返回矩阵元素的行号。默认值 0</param>
	/// <param name="column">待返回矩阵元素的列号。默认值 0</param>
	...
	/// <param name="matrixID">矩阵句柄数组。</param>
	/// <remarks>
